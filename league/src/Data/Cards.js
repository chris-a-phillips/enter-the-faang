...
const test = new AttackCard('test', 'attack', 1)
const test2 = new AttackCard('test2', 'attack', 2)
const test3 = new AttackCard('test3', 'attack', 3)
const test4 = new AttackCard('test4', 'attack', 4)
const test5 = new AttackCard('test5', 'attack', 5)
const test6 = new AttackCard('test6', 'attack', 6)
const test7 = new AttackCard('test7', 'attack', 7)
const test8 = new AttackCard('test8', 'attack', 8)
const test9 = new AttackCard('test9', 'attack', 9)
const test10 = new AttackCard('test10', 'attack', 10)
